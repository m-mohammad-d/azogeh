      ...
      <div className="flex flex-col ml-4 flex-grow">
        ...
        <div className="flex items-center justify-between mt-2">
          <div className="flex items-center">
            <button
              id="increment-btn"
              onClick={() => onIncrease(item._id)} // Use the passed function
            ...
            <span className="text-2xl text-gray-400 font-bold mx-2">{item.quantity}</span>
            <button
              id="decrement-btn"
              onClick={() => (item.quantity > 1 ? onDecrease(item._id) : onRemove(item._id))} // Use the passed function
