  ...
  return (
    <footer className="w-full max-w-screen-xl my-12 px-6 mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 w-full mt-8">
        <div>
          <h2 className="text-xl md:text-2xl font-semibold mb-4 text-neutral-gray-8">راهنما و خدمات مشتریان</h2>
        ...
        <div>
          <h2 className="text-xl md:text-2xl font-semibold mb-4 text-neutral-gray-8">ارتباط با آذوقه</h2>
          <div className="w-full min-h-[0.5px] mb-4 bg-gray-100"></div>
          <ul className="space-y-4 text-sm sm:text-base">
            <li>استخدام</li>
            <li>تماس با ما</li>
        ...
        <div>
          <h2 className="text-xl md:text-2xl font-semibold mb-4 text-neutral-gray-8">درباره آذوقه</h2>
          <div className="w-full min-h-[0.5px] mb-4 bg-gray-100"></div>
          <ul className="space-y-4 text-sm sm:text-base">
