      ...
      <div className="container mx-auto mb-12 text-center">
        ...
        <div className="space-y-6">
          ...
          <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5, ease: "easeOut" }} viewport={{ once: true }}>
            <div className="flex flex-col items-center justify-between gap-x-4 rounded-md border border-neutral-gray-4 bg-white p-6 shadow-md lg:flex-row-reverse">
              <div className="w-full md:w-1/3">
                <img src="avatar-frontend.jpg" alt="Frontend Developer Avatar" className="mx-auto mb-4 h-32 w-32 rounded-full" />
                <h2 className="mb-4 text-2xl font-bold text-gray-800">برنامه‌نویس فرانت‌اند</h2>
              </div>
              <div className="px-6">
                <div>
                  <p className="mb-4 text-lg text-gray-600">
                    ...
                    عملکرد خوبی داشته باشن، هم کیفیت بالا. برای این پروژه، از تکنولوژی‌هایی مثل React و Tailwind CSS استفاده کردم و حسابی روی جزئیات کار وقت گذاشتم. چالش‌های جدید برام هیجان‌انگیزن و
                    همیشه دنبال یادگیری ابزارها و تکنولوژی‌های به‌روز هستم تا بتونم توی کارم بهتر بشم. 😊
                  </p>
                  <p className="mb-4 text-lg text-gray-600">
          ...
          {/* بک‌اند دولوپر */}
          <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5, ease: "easeOut" }} viewport={{ once: true }}>
            <div className="flex flex-col items-center justify-between gap-x-4 rounded-md border border-neutral-gray-4 bg-white p-6 shadow-md lg:flex-row">
              <div className="md:w-1/3">
                <img src="/avatar-backend.png" alt="Backend Developer Avatar" className="mx-auto mb-4 h-32 w-32 rounded-full" />
                <h2 className="mb-4 text-2xl font-bold text-gray-800">برنامه‌نویس بک‌اند</h2>
              </div>

              <div className="px-6">
                <div>
                  <p className="mb-4 text-lg text-gray-600">
                    در این پروژه، من به عنوان توسعه‌دهنده بک‌اند مسئولیت طراحی و پیاده‌سازی بخش سرور را بر عهده داشتم. با استفاده از فناوری‌هایی مثل Node.js، Express، و TypeScript توانستم APIهایی سریع
                    و امن ایجاد کنم که نیازهای فرانت‌اند را به بهترین شکل ممکن پاسخ دهد.
                  </p>
                  <p className="mb-4 text-lg text-gray-600">
          ...
          <motion.div initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5, ease: "easeOut" }} viewport={{ once: true }}>
            <div className="flex flex-col items-center justify-between gap-x-4 rounded-md border border-neutral-gray-4 bg-white p-6 shadow-md lg:flex-row-reverse">
              <div className="md:w-1/3">
                ...
                <h2 className="mb-4 text-2xl font-bold text-gray-800">طراح UIUX</h2>
              </div>
              ...
              <div className="px-6">
                <div>
                  ...
                  <p className="mb-8 text-lg text-gray-600">
                    در مسیر طراحی، از تحلیل رفتار کاربران تا اجرای دقیق طرح های بصری و تعاملات کاربردی، تلاش می کنم پروژه ها به گونه ای توسعه یابند که هم از نظر زیباشناسی و هم از نظر کارایی در
                    بالاترین سطح قرار بگیرند.
                  </p>
                </div>
                <div className="flex justify-center space-x-4 space-x-reverse">
                  <a href="https://dribbble.com/Zekavati" target="_blank" rel="noopener noreferrer">
                    <FaDribbble size={30} className="text-pink-500" />
                  </a>
                  <a href="https://www.figma.com/@Marziehzekavati" target="_blank" rel="noopener noreferrer">
                    <img src="/icon/figma-icon.png" alt="figma" className="h-8 w-8" />
                  </a>
        ...
        <p className="mt-12 text-xl text-gray-600">خوشحال می‌شویم اگر با ما در ارتباط باشید و نظرات یا پیشنهادات خود را به اشتراک بگذارید!❤</p>
      </div>
    </div>
  );
};
